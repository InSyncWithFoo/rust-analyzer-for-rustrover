...
private const val ERROR_GROUP_ID = "insyncwithfoo.rustanalyzer.errors"
private const val INFORMATION_GROUP_ID = "insyncwithfoo.rustanalyzer.information"
private val ICON = RAIcon.TINY_16
...
internal fun Project.reportError(title: String, content: String) =
    errorNotificationGroup.error(title, content).notify(this)


internal fun Project.warn(title: String, content: String) =
    errorNotificationGroup.warning(title, content).notify(this)


internal fun Project.showInfo(title: String, content: String) =
    informationNotificationGroup.information(title, content).notify(this)
